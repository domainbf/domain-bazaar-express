...
BEGIN
  ...
  IF NOT (auth.uid() = v_offer.seller_id OR auth.uid() = v_offer.buyer_id OR public.is_admin(auth.uid())) THEN
  ...
  INSERT INTO public.transactions (
    ...
    jsonb_build_array(jsonb_build_object('stage', 'submitted', 'at', now(), 'note', '报价已接受，等待买家付款'))
  )
