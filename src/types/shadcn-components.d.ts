...
// This file extends React's type definitions to provide compatibility with shadcn/ui components
...
declare module 'react' {
  ...
  export interface HTMLAttributes<T> {
    ...
    // Add any other missing attributes you need
  }
}
...
// Create a global definition for shadcn-ui components
interface VariantProps<T> {
  [key: string]: any;
}

// Fix for ESLint's typescript-eslint plugin when it complains about untyped function calls
