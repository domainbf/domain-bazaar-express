...
export const DomainStatusManager = ({ domain, onStatusChange }: DomainStatusManagerProps) => {
  ...
  const statusOptions = [
    { value: 'available', label: '可售', icon: PackageCheck, color: 'text-success ' },
    { value: 'pending', label: '暂不出售', icon: Package, color: 'text-warning ' },
    { value: 'reserved', label: '保留', icon: Package, color: 'text-primary ' },
