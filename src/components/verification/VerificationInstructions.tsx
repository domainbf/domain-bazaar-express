        ...
        {verification.verification_type === 'dns' ? (
                ...
                <Alert className="border-warning/50 bg-warning/10 ">
                  ...
                  <AlertDescription className="text-sm text-warning ">
                    ...
                    <ul className="mt-2 space-y-1 list-disc list-inside">
                      <li><strong>主机记录</strong>只需填写 <code className="bg-warning/15  px-1 rounded">_domainverify</code></li>
          ...
          <div className="space-y-4">
            ...
            <div className={`${isMobile ? 'overflow-x-auto' : ''} bg-muted p-4 rounded-md space-y-3`}>
              ...
              <div className="flex items-center mt-3 p-2 bg-warning/10  rounded border border-warning/30 ">
                <Mail className="h-4 w-4 text-warning  mr-2 shrink-0" />
