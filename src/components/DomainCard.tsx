...
export const DomainCard = ({ domain, price, isSold = false }: DomainCardProps) => {
  ...
  return (
    <div className="glass-card rounded-xl p-6 relative overflow-hidden group transition-all duration-300">
      ...
      <div className="flex flex-col items-center space-y-4">
        <h3 className="text-2xl font-bold text-white relative z-10">{domain}</h3>
        
        {price && (
          <div className="text-xl font-semibold text-purple-400 relative z-10">
            ${price}
          </div>
        )}
        ...
        {isSold ? (
          ...
          <Dialog>
            <DialogTrigger asChild>
              <Button 
                className="w-full bg-gradient-to-r from-purple-500 to-cyan-500 hover:from-purple-600 hover:to-cyan-600 relative z-10"
              >
                {t('makeOffer')}
              </Button>
            </DialogTrigger>
