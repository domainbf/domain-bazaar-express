            ...
            <tr key={user.id} className="border-b hover:bg-muted/50">
              ...
              <td className="p-4">
                <div className="flex flex-col gap-1">
                  {user.is_seller && (
                    <span className="inline-flex items-center text-xs px-2 py-1 rounded-full bg-info/10 text-info ">
                      Seller
                    </span>
                  )}
                  {user.seller_verified && (
                    <span className="inline-flex items-center text-xs px-2 py-1 rounded-full bg-success/10 text-success ">
