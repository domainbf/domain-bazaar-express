  ...
  return (
    <section className="py-12 md:py-16 bg-background">
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        ...
        >
          <div className="inline-flex items-center justify-center w-14 h-14 bg-muted border border-border rounded-2xl mb-4">
              ...
              <Link to={item.link}>
                <Card className="h-full border border-border bg-card hover:border-foreground/20 transition-colors">
                  <CardContent className="p-4 md:p-5">
                    ...
                    <div className="mt-3 flex items-center text-xs md:text-sm font-semibold text-muted-foreground">
                      了解更多
